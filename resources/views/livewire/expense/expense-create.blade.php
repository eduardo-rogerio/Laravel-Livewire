<div class="max-w-7xl mx-auto py-15 px-4">
    ...
    <form action="" wire:submit.prevent="createExpense" class="w-full max-w-7xl mx-auto">
        <div class="flex flex-wrap -mx-3 mb-6">
            ...
            <p class="w-full px-3 mb-6 md:mb-0">
                <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2">Data do Comprovante,
                    pode deixar em branco se o dia for hoje</label>
                <input type="datetime-local" name="expense_date" wire:model="expenseDate"
        ...
        <div class="w-full py-4 px-3 mb-6 md:mb-0">
            ...
            <button type="submit"
                    class="px-4 py-2 border rounded bg-indigo-500 text-white">Criar Registro
            </button>
        </div>
